...
You can leverage the `CRUDEvent.metadata` JSON field when you want to save some other related data to each change. For example when aggregating the changes across multiple models by some specific business logic.
